...
<cfcomponent displayname="oauthconsumer">
	...
	<cffunction name="init"	access="public" returntype="oauthconsumer">
		...
		<cfargument name="sPathToPrivateKey" 		required="false" 	type="string" default="" 	hint="path to private key">
		...
		<cfset setPathToPrivateKey(arguments.sPathToPrivateKey)>
	...
	<cffunction name="getPathToPrivateKey" access="public" returntype="string">
		<cfreturn variables.sPathToPrivateKey>
	</cffunction>
	<cffunction name="setPathToPrivateKey" access="public" returntype="void">
		<cfargument name="sPathToPrivateKey" type="string" required="yes">
		<cfset variables.sPathToPrivateKey = trim(arguments.sPathToPrivateKey)>
	</cffunction>
